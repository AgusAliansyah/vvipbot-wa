...
const BotName = 'I'M BOT'; 
const instagram = 'ardiyano_16- kaelMk_'; 
const aktif = 'Kapan bot aktif';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Ardi\n' // Nama kamu
            + 'ORG:I'M;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6283899211400:+62 838-9921-1400\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
//Hay guest
//create @ardiyan don't delate this please
